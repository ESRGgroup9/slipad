...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{09sw_specification/RS/CClient/init}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{09sw_specification/RS/CClient/run}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{09sw_specification/RS/CClient/tRecv}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{09sw_specification/RS/start}
