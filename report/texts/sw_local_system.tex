...
\begin{figure}[H]
	\centering
	\includegraphics[width=.35\textwidth]{09sw_specification/LS/cparkdetection/class}
...
\begin{itemize}
\item \textbf{CLocalSystem::condRecvSensors:}
\item \textbf{CLocalSystem::condCamFrame:}
\item \textbf{CSensors::condReadLdr:}
\item \textbf{CSensors::condReadLampf:}
\item \textbf{CCommunication::condtSend:}
\end{itemize}
...
\begin{itemize}
	\item \textbf{CLocalSystem::mutRecvSensors:}
	\item \textbf{CLocalSystem::mutCamFrame:}
	\item \textbf{CSensors::mutReadLdr:}
	\item \textbf{CSensors::mutReadLampf:}
	\item \textbf{CCommunication::mutComms:}
	\item \textbf{CCommunication::mutTxMsgs:}
	\item \textbf{CLamp::mutChangePWM:}
\end{itemize}

\myparagraph{Signals}

A signal is a software generated interrupt that is sent to a process by the OS. There are fix set of signals that can be sent to a process, which are identified by integers. Signal number have symbolic names.
