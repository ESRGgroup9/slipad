...
In figure \ref{fig:classDiag} is represented the class diagram of the local system. The class \textit{CLocalSystem} is the main class of the system, i.e, the main process, which initializes the objects of each class listed below.
...
\begin{itemize}
	\item \textbf{CPir:} manages the motion detectior, PIR;
	\item \textbf{CLdr:} manages the ambient light sensor, LDR;
	\item \textbf{CFailureDet:} manages the lamp failure detector;
\end{itemize}
%*****************************
\clearpage
