...
\begin{table}[H]
	...
	\resizebox{\columnwidth}{!}
	{
		\begin{tabular}{|m{3cm}|m{5cm}||m{5cm}|}
			...
			\textbf{Event} & \textbf{Expected Output} & \textbf{Real Output}
			\\\hline\hline
			Establish connection & Stable connection & -
			\\\hline
...
In order to provide a lower voltage to power sensors and the Raspberry Pi, it is necessary to use a step down module, as the one shown in figure \ref{fig:step_down}
...
\begin{table}[H]
	...
	\begin{tablenotes}
		\small
		\item[*] This module provides 5 A for the both output pins combined.
	\end{tablenotes}
	\end{threeparttable}
...
\begin{table}[H]
	...
	\begin{tabular}{|m{5cm}|m{6cm}|}
		\hline
		\textbf{Step Down} & \textbf{Raspberry Pi}
		\\\hline\hline
	...
	\caption{Connection scheme: Power Module.}
...
\begin{table}[H]
	...
	\resizebox{\columnwidth}{!}
	{
		\begin{tabular}{|m{3cm}|m{5cm}||m{5cm}|}
			...
			\textbf{Event} & \textbf{Expected Output} & \textbf{Real Output}
			\\\hline\hline
			Connect to power supply & Provide 5 V / 5 A & -
			\\\hline
		\end{tabular}
	}
