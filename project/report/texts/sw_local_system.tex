...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\textwidth]{09sw_specification/LSpriority}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{09sw_specification/classDiagram}
...
\myparagraph{Class CCommunications}

In figure \ref{fig:LoraCommClass} is shown the Communications class diagram. This class defines an object \textit{LoraComm} capable of establishing a LoRa communication with the gateway and send messages. It's used a vector of messages \textit{tx\_msgs} to store the message that's in the waiting list to be sent, in order to avoid the loss of a communication.

\begin{figure}[H]
	\centering
	\includegraphics[width=.5\textwidth]{09sw_specification/LoraCommClass}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.6\textwidth]{09sw_specification/LoraComm}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.3\textwidth]{09sw_specification/LoraCommPush}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.25\textwidth]{09sw_specification/LoraCommRun}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\textwidth]{09sw_specification/LoraCommSend}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.3\textwidth]{09sw_specification/LoraCommRecv}
...
\begin{figure}[H]
	\centering			
	\includegraphics[width=1\textwidth]{09sw_specification/tCamera}
...
\begin{figure}[H]
	\centering			
	\includegraphics[width=.5\textwidth]{09sw_specification/searchParkingSpots}
...
\begin{figure}[H]
	\centering		\includegraphics[width=.55\textwidth]{09sw_specification/LStLoraRecv}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.4\textwidth]{09sw_specification/pir_isr}
...
In figure \ref{fig:bootLS} is shown the start-up process for the local system. When booting up, the local system creates all necessary objects, as presented previously, and initializes them.
