...
\begin{figure}[H]
	\centering
	\includegraphics[width=.65\textwidth]{09sw_specification/lst_priority}
...
\begin{itemize}
	...
	\item \textbf{CCommunication:} manages the LoRa communications, interfacing with the LoRa module;
...
>>>>>>> aea98275a087e4b719cd102515080b51f1822a30
...
In the figure, one can see the two primary constructors of the system, responsible for creating a Lamp object and a Communication. In the Lamp constructor the PWM module is initialized as the mutexes used. In the Communication constructor the LoRa module is initialized, at 433 MHz, beginning LoRa communication, initializing all mutexes and variables and creating all necessary threads. Besides this modules 

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{09sw_specification/bootLS}
