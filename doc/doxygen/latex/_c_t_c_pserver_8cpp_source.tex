...
\DoxyCodeLine{\Hypertarget{_c_t_c_pserver_8cpp_source_l00013}00013 CTCPserver::CTCPserver(\textcolor{keywordtype}{int} port)}
...
\DoxyCodeLine{\Hypertarget{_c_t_c_pserver_8cpp_source_l00040}00040     char hostName[32];}
\DoxyCodeLine{\Hypertarget{_c_t_c_pserver_8cpp_source_l00041}00041     gethostname(hostName, sizeof(hostName));}
\DoxyCodeLine{\Hypertarget{_c_t_c_pserver_8cpp_source_l00042}00042     DEBUG\_MSG("{}[\mbox{\hyperlink{class_c_t_c_pserver}{CTCPserver}}] Starting server on "{} << hostName << "{}:"{} << port);}
\DoxyCodeLine{\Hypertarget{_c_t_c_pserver_8cpp_source_l00043}00043     DEBUG\_MSG("{}[\mbox{\hyperlink{class_c_t_c_pserver}{CTCPserver}}] Listening for incoming connections on sockfd: "{} << listenSd);}
...
\DoxyCodeLine{\Hypertarget{_c_t_c_pserver_8cpp_source_l00046}00046 \mbox{\hyperlink{class_c_t_c_pserver}{CTCPserver}}::\string~\mbox{\hyperlink{class_c_t_c_pserver}{CTCPserver}}()}
...
\DoxyCodeLine{\Hypertarget{_c_t_c_pserver_8cpp_source_l00051}00051 \textcolor{keywordtype}{int} CTCPserver::accept()}
...
\DoxyCodeLine{\Hypertarget{_c_t_c_pserver_8cpp_source_l00055}00055     \textcolor{keywordtype}{int} sd = ::accept(listenSd, (\textcolor{keyword}{struct} sockaddr*)\&addr, \&n);}
